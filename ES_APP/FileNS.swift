...
class FileNS {
    ...
    func fetchFileData() async throws -> FileParsing {
        ...
        //https://ipm02.eisenfuhr.com/workflow/GetList?context=P6.AKTE&listId=APP+001P6.AKTE&rowCount=1000&json=True
        
        let url = URL(string: "https://ipm02.eisenfuhr.com/workflow/GetList?context=P6.AKTE&listId=APP+001P6.AKTE&rowCount=1000&json=True")!
